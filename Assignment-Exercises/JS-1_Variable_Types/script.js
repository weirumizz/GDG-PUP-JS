...
let hobbies = ["drawing", "reading", "travelling"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
// Using const
const pi = 420; // Define a number here, e.g., 3.14159
const birthYear = 2003; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = ["ORV", "The Picture of Dorian Gray"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Caloocan City"; // Define a string here, e.g., "New York"
